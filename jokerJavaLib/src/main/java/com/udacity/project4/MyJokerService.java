...
public class MyJokerService {
    ...
    public MyJokerService(){
        ...
        jokers[3] = new MyJokerModel("Some people just have a way with words, and other people … oh … not have way.","Steve Martin");
    }

    public String getJoke(int jokeId){
        return jokers[jokeId].getJoke()+"/n"+jokers[jokeId].getAuthor();
    }
